...
var G__4703 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__4703;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__4704 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__4704,ch);
...
if(("\\" === ch__$1)){
var ch_4705__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_4705__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_4705__$2);
} else {
}

var G__4706 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__4706;
continue;
}
}
...
var vec__4714 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__4714,(0),null);
var start_column = cljs.core.nth.call(null,vec__4714,(1),null);
...
var G__4717 = cljs.core.conj_BANG_.call(null,a,form);
a = G__4717;
continue;
}
}
...
var _STAR_read_delim_STAR__orig_val__4718 = cljs.tools.reader._STAR_read_delim_STAR_;
var _STAR_read_delim_STAR__temp_val__4719 = true;
cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__temp_val__4719;

try{return cljs.tools.reader.read_delimited_internal.call(null,kind,delim,rdr,opts,pending_forms);
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__orig_val__4718;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__4720 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__4720,(0),null);
var start_column = cljs.core.nth.call(null,vec__4720,(1),null);
...
var vec__4723 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__4723,(0),null);
var end_column = cljs.core.nth.call(null,vec__4723,(1),null);
...
var vec__4726 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__4726,(0),null);
var start_column = cljs.core.nth.call(null,vec__4726,(1),null);
...
var vec__4729 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__4729,(0),null);
var end_column = cljs.core.nth.call(null,vec__4729,(1),null);
...
var vec__4732 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__4732,(0),null);
var start_column = cljs.core.nth.call(null,vec__4732,(1),null);
...
var vec__4735 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__4735,(0),null);
var end_column = cljs.core.nth.call(null,vec__4735,(1),null);
...
var sb = (function (){var G__4738 = (new goog.string.StringBuffer());
G__4738.append(initch);
...
var G__4740 = (function (){var G__4739 = sb;
G__4739.append(ch);

return G__4739;
})();
var G__4741 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__4740;
ch = G__4741;
continue;
}
...
switch (G__4744) {
case "\\":
var G__4748 = (function (){var G__4745 = sb;
G__4745.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__4745;
})();
var G__4749 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__4748;
ch = G__4749;
continue;
...
break;
default:
var G__4750 = (function (){var G__4746 = sb;
G__4746.append(ch);

return G__4746;
})();
var G__4751 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__4750;
ch = G__4751;
continue;
...
var vec__4752 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__4752,(0),null);
var end_column = cljs.core.nth.call(null,vec__4752,(1),null);
...
var vec__4755 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__4755,(0),null);
var column = cljs.core.nth.call(null,vec__4755,(1),null);
...
var vec__4760 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__4760,(0),null);
var column = cljs.core.nth.call(null,vec__4760,(1),null);
...
var vec__4765 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__4765,(0),null);
var column = cljs.core.nth.call(null,vec__4765,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__4770 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__4770,(0),null);
var start_column = cljs.core.nth.call(null,vec__4770,(1),null);
...
var vec__4773 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__4773,(0),null);
var end_column = cljs.core.nth.call(null,vec__4773,(1),null);
...
var G__4776 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__4776,true,null,opts,pending_forms);
...
var G__4777 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__4777)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__4777)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__4777)){
...
var _STAR_suppress_read_STAR__orig_val__4778 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__4779 = true;
cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__4779;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__4778;
}});
...
var G__4780 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__4780,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__4780,rdr,first_line);
...
var G__4784 = matched;
var G__4785 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__4784;
finished = G__4785;
continue;
} else {
...
var _STAR_suppress_read_STAR__orig_val__4786 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__4787 = (function (){var or__4131__auto__ = cljs.tools.reader._STAR_suppress_read_STAR_;
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
...
cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__4787;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__4786;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env_orig_val__4788 = cljs.tools.reader.arg_env;
var arg_env_temp_val__4789 = cljs.core.sorted_map.call(null);
cljs.tools.reader.arg_env = arg_env_temp_val__4789;

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__4790 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__4790,"(");
...
var G__4791 = (i + (1));
var G__4792 = cljs.core.conj_BANG_.call(null,args,(function (){var or__4131__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env_orig_val__4788;
}});
/**
...
var ch = temp__4655__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__4793 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__4793);
...
var G__4794 = cljs.core.next.call(null,s__$1);
var G__4795 = ret;
s__$1 = G__4794;
r = G__4795;
continue;
...
var G__4796 = cljs.core.next.call(null,s);
var G__4797 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__4796;
key_vals = G__4797;
continue;
} else {
...
var gensym_env_orig_val__4801 = cljs.tools.reader.gensym_env;
var gensym_env_temp_val__4802 = cljs.core.PersistentArrayMap.EMPTY;
cljs.tools.reader.gensym_env = gensym_env_temp_val__4802;
...
}finally {cljs.tools.reader.gensym_env = gensym_env_orig_val__4801;
}});
...
var temp__4655__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__4803 = token;
var G__4803__$1 = (((G__4803 == null))?null:cljs.core.subs.call(null,G__4803,(1)));
var G__4803__$2 = (((G__4803__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__4803__$1));
var G__4803__$3 = (((G__4803__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__4803__$2));
var G__4803__$4 = (((G__4803__$3 == null))?null:cljs.core.symbol.call(null,G__4803__$3));
if((G__4803__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__4803__$4);
}
})():(function (){var G__4804 = token;
var G__4804__$1 = (((G__4804 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__4804));
if((G__4804__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__4804__$1);
}
})()
));
if(cljs.core.truth_(temp__4655__auto__)){
...
}catch (e4811){if((e4811 instanceof Error)){
var e = e4811;
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__4815,reader){
...
var opts = map__4816__$1;
var eof = cljs.core.get.call(null,map__4816__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
var len__4730__auto___4824 = arguments.length;
var i__4731__auto___4825 = (0);
while(true){
if((i__4731__auto___4825 < len__4730__auto___4824)){
args__4736__auto__.push((arguments[i__4731__auto___4825]));

var G__4826 = (i__4731__auto___4825 + (1));
i__4731__auto___4825 = G__4826;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq4822){
var G__4823 = cljs.core.first.call(null,seq4822);
var seq4822__$1 = cljs.core.next.call(null,seq4822);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__4823,seq4822__$1);
});
