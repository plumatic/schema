...
;; TODO: tidy up these pseudo-schema docs, figure out where they go (maybe just on the constructor?)
(defrecord CollectionSpec
    [pre ;- spec/Precondition
     constructor ;- (s/pred fn?)
...
(defn collection-spec
  [pre constructor elements on-error]
